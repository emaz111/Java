...
/**
 * Created by u1859269 on 26/11/2018.
 */
public class Employee {
    ...
    public String parkingPermitStatus () {
        if ((this.jobTitle.startsWith ("Senior")) && (this.getSalary () > 22000)) {
            return "Week1.Employee is permitted a car parking space.";
        }
        else {
            return "Week1.Employee is not permitted a car parking space.";
        }
    }

    @Override
    public String toString () {
        final StringBuilder sb = new StringBuilder ("Week1.Employee{");
